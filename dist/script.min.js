$(document).ready((function() {
	function e(e, t, ...a) {
		if ("string" != typeof e) throw Error("Argument 'htmlString' is required and must be a string");
		const i = document.createElement(e);
		if ("object" == typeof t)
			for (let e in t) "on" === e.substring(0, 2) ? i.addEventListener(e.substring(2).toLowerCase(), t[e]) : i.setAttribute(e, t[e]);
		return a.forEach((function(e) {
			let t;
			t = e.constructor.name.includes("Element") ? e : document.createTextNode(e), i.appendChild(t)
		})), i
	}
	...
	if (window.location.href.indexOf("event") > -1) {
		const a = JSON.parse(localStorage.getItem("currentEvent")) || {
			...
			}, a.description || t(100)), e("a", {
				class: "btn btn-primary",
				href: "tickets.html"
			}, "Buy Tickets"))));
		i.appendChild(o)
	}
	if (dateConverter = function(e) {
			const t = new Date(e),
				a = t.getFullYear();
			return ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][t.getMonth()] + " " + t.getDate() + ", " + a
		...
		t.addEventListener("click", (function() {
			i.removeChild(o), i.removeChild(r), i.append(e("div", {
				class: "modal-body"
			}, e("h5", {
				class: "modal-title"
